...
/**
 * Backup implementation for the (tool_log) logstore_usage subplugin.
 *
...
class backup_logstore_usage_subplugin extends backup_tool_log_logstore_subplugin {
    ...
    protected function define_logstore_subplugin_structure() {
        ...
        $subpluginlog = new backup_nested_element('logstore_usage_log', array('id'), array(
        ...
        $subpluginlog->set_source_table('logstore_usage_log', array('contextid' => backup::VAR_CONTEXTID));
